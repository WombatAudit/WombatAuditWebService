            ...
            <div class="tile">
                <section class="invoice">
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="window.location.href='/wombataudit/admin/projects/${prj.prjId?c}/items/${item.itemId}'"
                    ...
                    <div class="row d-print-none mt-2">
                        ...
                        <div class="col-6 text-right"><a class="btn btn-primary" href="javascript:window.print();"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="8" placeholder="Enter your feedback"
