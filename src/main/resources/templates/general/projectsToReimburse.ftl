    ...
    <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item active" href="/wombataudit/general/projects/toReimburse" rel="noopener"><i
...
<main class="app-content">
    ...
    <div class="col-md-12">
        <div class="tile">
            <h3 class="tile-title">All projects to reimburse</h3>
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="window.location.href='/wombataudit/general/projects/${prj.prjId?c}'"
