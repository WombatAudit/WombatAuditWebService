    ...
    <ul class="app-menu">
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item active" href="/wombataudit/general/organizations"><i
...
<main class="app-content">
    <div class="app-title">
        <div class="div">
            <h1><i class="fa fa-laptop"></i> Create new organization</h1>
        </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="tile">
                <h3 class="tile-title">New Organization</h3>
                <div class="tile-body">
                    <form method="post" action="/wombataudit/general/organizations"
                          enctype="application/x-www-form-urlencoded">
                        <div class="form-group">
                            <label class="control-label">Name</label>
                            <input class="form-control" type="text" placeholder="Enter organization name" name="name">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Description</label>
                            <input class="form-control" type="text" placeholder="Enter organization description"
                                   name="description">
                        </div>
                        <input value="${user.companyId?c}" name="companyId" type="hidden">
                        <div class="tile-footer">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Create
                            </button>
                        </div>
                    </form>
                </div>
