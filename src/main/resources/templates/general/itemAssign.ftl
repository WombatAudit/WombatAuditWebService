...
<main class="app-content">
    ...
    <div class="tile mb-4">
        ...
        <#if receiverList??>
            <div class="row mb-2">
                <div class="col-12"><strong>Has assigned to </strong>&nbsp;&nbsp;&nbsp;<#list receiverList as receiver>${receiver.realName}&nbsp;&nbsp;&nbsp;</#list></div>
            </div>
        </#if>
    </div>
                ...
                <div class="tile-body">
                    <form method="post" enctype="application/x-www-form-urlencoded" action="/wombataudit/general/projects/${item.prjId?c}/items/${item.itemId?c}/actions/assign">
                        ...
                        <div class="tile-footer">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Assign</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="/wombataudit/general/projects/${item.prjId?c}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
