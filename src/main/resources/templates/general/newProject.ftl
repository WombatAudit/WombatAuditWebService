...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item active" href="/wombataudit/general/projects/pages/create"><i
            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    <form enctype="application/x-www-form-urlencoded" method="post"
                          action="/wombataudit/general/projects">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" class="form-control" placeholder="Enter project description"
                                      name="description"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Start Time</label>
                            <input class="form-control" type="datetime-local" placeholder="Enter project start time"
                                   name="startTime">
                        </div>
                        <div class="form-group">
                            <label class="control-label">End Time</label>
                            <input class="form-control" type="datetime-local" placeholder="Enter project end time"
                                   name="endTime">
                        </div>
