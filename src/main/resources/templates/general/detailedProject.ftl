    ...
    <div class="app-title">
        <div class="div">
            ...
            <#switch prj.status>
                ...
                <#case 1>Request to create<#break>
                <#case 2>In progress<#break>
                <#case 3>Request to reimburse<#break>
                ...
                <div class="tile-title-w-btn">
                    ...
                    <#if manage?? && prj.status==0>
                        <div class="btn-group"><a class="btn btn-success"
                                                  href="/wombataudit/general/projects/${prj.prjId?c}/actions/request"><i
                                class="fa fa-lg fa-check-square-o"></i></a><a class="btn btn-primary"
                                                                              href="/wombataudit/general/projects/${prj.prjId?c}/pages/update"><i
                                class="fa fa-lg fa-edit"></i></a></div>
                    </#if>
                    <#if manage?? && prj.status==2>
                        <div class="btn-group"><a class="btn btn-success"
                                                  href="/wombataudit/general/projects/${prj.prjId?c}/actions/request"><i
                                class="fa fa-lg fa-check-square-o"></i></a></div>
                    </#if>
                </div>
                <div class="tile-body">
                    <p><strong>Organization</strong>&nbsp;&nbsp;&nbsp;${prj.orgName}</p>
                    <p>${prj.description}</p>
                    <p><strong>Time</strong>&nbsp;&nbsp;&nbsp;${prj.startTime?datetime}
                        &nbsp;&minus;&nbsp;${prj.endTime?datetime}</p>
                </div>
            </div>
        </div>
        <div id="version-info" class="col-md-4">
            <div class="tile">
                <div class="tile-title-w-btn">
                    ...
                    <#if manage?? && prj.status==0>
                        <div class="btn-group">
                            <button id="bt-add-version" class="btn btn-primary" href="#"><i
                                    class="fa fa-lg fa-plus"></i></button>
                            <button id="bt-version-switch" class="btn btn-primary" href="#"><i
                ...
                <div class="tile-footer">
                    <#if prj.status==0>
                        <#if manage??>
                            <button id="bt-add-item" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Add Item
                            </button>
                        </#if>
                    </#if>
                </div>
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form method="get" id="switch">
                            ...
                            <div class="tile-footer">
                                <button id="do-switch" class="btn btn-primary"><i
                                        class="fa fa-fw fa-lg fa-code-fork"></i>Switch
                                </button>&nbsp;&nbsp;&nbsp;
                                <button id="bt-version-confirm" class="btn btn-success" type="button"><i
                                        class="fa fa-fw fa-lg fa-check-circle"></i>Confirm
                                </button>&nbsp;&nbsp;&nbsp;
                                <button id="bt-cancel-version-switch" class="btn btn-secondary" type="button"><i
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form method="post" enctype="application/x-www-form-urlencoded"
                              action="/wombataudit/general/projects/${prj.prjId}/${prj.versionId}/items">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text">&yen;</span>
                                            </div>
                                            <input class="form-control" id="exampleInputAmount" type="number"
                                                   step="0.01" placeholder="Amount" name="amount">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" rows="3" placeholder="Enter item description"
                            ...
                            <div class="tile-footer">
                                ...
                                <button id="bt-cancel-add-item" class="btn btn-secondary" type="button"><i
                                        class="fa fa-fw fa-lg fa-times-circle"></i>Cancel
                                </button>
                            </div>
                        </form>
        ...
        <div id="add-version" class="row">
            ...
            <div class="col-md-5">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form method="post" enctype="application/x-www-form-urlencoded"
                              action="/wombataudit/general/projects/${prj.prjId?c}/versions">
                            <div class="row">
                            ...
                            <div class="tile-footer">
                                ...
                                <button id="bt-cancel-add-version" class="btn btn-secondary" type="button"><i
                                        class="fa fa-fw fa-lg fa-times-circle"></i>Cancel
                                </button>
                            </div>
                        </form>
                ...
                <#list prj.itemDTOList as item>
                    <div class="col-md-4">
                        <div class="tile">
                                ...
                                <#if manage??>
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-primary"
                                           href="/wombataudit/general/projects/${prj.prjId}/${prj.versionId}/items/${item.itemId}/actions/delete"><i
                            ...
                            <div class="tile-body">
                                <p>
                                    <strong>${item.type}</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Quantity</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${item.quantity}
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Amount</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&yen;${item.amount}
                                </p>
                        ...
                        <div class="tile">
                            <div class="tile-title-w-btn">
                                ...
                                <#if manage??>
                                    <div class="btn-group">
                                        <a class="btn btn-primary"
                                           href="/wombataudit/general/projects/${prj.prjId?c}/items/${item.itemId?c}/pages/assign"><i
                                                class="fa fa-lg fa-users"></i></a>
                                        <a class="btn btn-primary"
                                           href="/wombataudit/general/projects/${prj.prjId?c}/items/${item.itemId?c}"><i
